<footer id="colophon" class="site-footer site-footer-social" role="contentinfo">
	...
	<div class="site-footer-icons">
        <div class="site-container">
        	...
        	<div class="site-footer-social-ad"><i class="fa fa-map-marker"></i> <?php echo wp_kses_post( get_theme_mod( 'vogue-website-site-add', __( 'Av. Santa Catalina 543, Lima', 'DYPZ' ) ) ) ?>
        	
			<!--<?php printf( __( '</div><div class="site-footer-social-copy">Theme: %1$s by %2$s', 'DYPZ' ), 'Theme', '<a href="#"></a></div><div class="clearboth"></div>' ); ?>-->
        </div>
    </div>
